...
// REUTILIZABLES
    ...
    limpiarFormulario(data: any = false) {
        ...
        this.frmConvocatoriaControl.idEstadoEvaluacion.reset(data ? data.idEstadoEvaluacion : '');
     //   this.frmConvocatoriaControl.iProyectoId.reset(data ? data.iProyectoId : '');
        ...
        this.frmConvocatoriaControl.nPuntajeTotal.reset(data ? data.nPuntajeTotal : '');
        this.frmConvocatoriaControl.nPuntajePonderado.reset(data ? data.nPuntajePonderado : '');
