...
@Component({
    selector: 'app-evaluadores-proyecto',
    templateUrl: './evaluadores-proyecto.component.html',
    styleUrls: ['./evaluadores-proyecto.component.scss']
})

export class EvaluadoresProyectoComponent implements OnInit {
    dataServidor = {
        mostrarLista: null,
        tipoPersonas: null,
        ...
        switch (data[0]) {
            ...
            case 'consultar_persona':
                ...
                this.dataServidor.persona = await this.queryInvestigacion.datosServidorAsync({
                    tipo: 'data_personas_evaluadores',
                ...
                if (this.dataServidor.persona.length > 0){
                    ...
                    this.frmPersonaControl.iParEvaluadorId.setValue(this.dataServidor.persona[0].iParEvaluadorId);
                    ...
                    this.frmPersonaControl.regina.setValue(this.dataServidor.persona[0].cRegina);
                    this.frmPersonaControl.institucion.setValue(this.dataServidor.persona[0].cInstitucion);
                    this.frmPersonaControl.grado_academico.setValue(this.dataServidor.persona[0].cMaxGradoAcademico);
                    this.frmPersonaControl.h.setValue(this.dataServidor.persona[0].cH);
                    this.frmPersonaControl.linea_investigacion.setValue(this.dataServidor.persona[0].cLineaInvestigacion);
                    this.frmPersonaControl.cuenta_bancaria.setValue(this.dataServidor.persona[0].cNumCta);
                    this.frmPersonaControl.banco.setValue(this.dataServidor.persona[0].cBanco);
                    this.frmPersonaControl.observacion.setValue(this.dataServidor.persona[0].cObservacion);
                    this.frmPersonaControl.cci.setValue(this.dataServidor.persona[0].cCci);
            ...
            case 'editar':
                ...
                this.imprimir.modalPreTitulo = 'Editar ParEvaluador ';
...
// REUTILIZABLES
    async cargarLista() {
        ...
        this.dataServidor.mostrarLista = await this.queryInvestigacion.datosServidorAsync({
            tipo: 'pares_evaluadores',
            data: [1, valBus]
        });
    }
    ...
    limpiarFormulario(data: any = false, val = 0) {
        // console.log(data);
        this.frmPersonaControl.idTipoPersona.reset(1);
        if (val == 0){
        ...
        this.frmPersonaControl.regina.reset(data ? data.cRegina : '');
        this.frmPersonaControl.institucion.reset(data ? data.cInstitucion : '');
        this.frmPersonaControl.grado_academico.reset(data ? data.cMaxGradoAcademico : '');
        this.frmPersonaControl.h.reset(data ? data.cH : '');
        this.frmPersonaControl.linea_investigacion.reset(data ? data.cLineaInvestigacion : '');
        this.frmPersonaControl.cuenta_bancaria.reset(data ? data.cNumCta : '');
        this.frmPersonaControl.banco.reset(data ? data.cBanco : '');
        this.frmPersonaControl.cci.reset(data ? data.cCci : '');
        this.frmPersonaControl.observacion.reset(data ? data.cObservacion : '');

        this.frmPersonaControl.iPersId.reset(data ? data.iPersId : '');
        this.frmPersonaControl.iParEvaluadorId.reset(data ? data.iParEvaluadorId : '');
