        ...
        switch (data[0]) {
            ...
            case 'consultar_persona':
                ...
                if (this.dataServidor.persona.length > 0){
                    ...
                    this.frmPersonaControl.iMonitorId.setValue(this.dataServidor.persona[0].iMonitorId);
                    ...
                    this.frmPersonaControl.grado.setValue(this.dataServidor.persona[0].cGradoMonitor);
                    this.mostrarPide = 0;
            ...
            case 'editar':
                ...
                this.imprimir.modalPreTitulo = 'Editar Monitor ';
...
// REUTILIZABLES
    async cargarLista() {
        ...
        this.dataServidor.listaMonitores = await this.queryInvestigacion.datosServidorAsync({
            tipo: 'data_monitores',
            data: [1, valBus]
        });
    }
    ...
    limpiarFormulario(data: any = false, val = 0) {
        ...
        this.frmPersonaControl.iMonitorId.reset(data ? data.iMonitorId : '');
