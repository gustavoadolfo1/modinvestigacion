...
@Component({
  selector: 'app-ht-font-awesome',
  templateUrl: './ht-font-awesome.component.html',
  styleUrls: ['./ht-font-awesome.component.scss']
})
export class HtFontAwesomeComponent implements OnInit {
    @Input() name        : string;
    // Optional Inputs
    @Input() title      ?: string;
    @Input() size       ?: string;
